...
// Need to redo this, doesn't work at all....
// Have a copy of this so can delete it all to try to improve it
...
uint32_t pixel_array[NUM_PIXELS * 3] = {0};
...
void dma_init(PIO pio, uint sm) {
    ...
    dma_channel_configure(
        ...
        &pio->txf[sm],
        NULL,
        NUM_PIXELS * 3,      // CHANGE ?? how much do I want?
        false
    );
